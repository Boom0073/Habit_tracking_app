...
class AppColors {
  //few grayscale variants, we will use for certain UI elements.
  ...
  static final black20 = const Color(0xFF000000).withOpacity(0.0);
  static final black50 = const Color(0xFF000000).withOpacity(0.5);
  //All these different color swatches which represent different variatopns of the
  //color themes that are supported by this app.
  //Each one of this set of colors represents one of the themes that can be selected
  //with the UI.
  static const red = [
    Color(0xFFF66B4A),
    Color(0xFFDD6142),
