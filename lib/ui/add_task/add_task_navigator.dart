...
import 'package:habit_tracker/ui/add_task/add_task_page.dart';
...
class AddTaskNavigator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    //*Using a nested navigator to show the 'AddTaskPage' and 'TaskDetailPage'
        ...
        builder: (context) {
          switch (routeSettings.name) {
            ...
            case AddTaskRoutes.confirmTask:
              //* The TaskPreset is passed to the route arguments, so here we extract it
              //and use it to create a new Task object
              final taskPreset = routeSettings.arguments as TaskPreset;
              final task = Task.create(
                  name: taskPreset.name, iconName: taskPreset.iconName);
