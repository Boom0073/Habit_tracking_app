...
class AppThemeData {
  ...
  static AppThemeData lerp(AppThemeData a, AppThemeData b, double t) {
    ...
    return AppThemeData(
      ...
      settingsListIconBackground: Color.lerp(a.settingsInactiveIconBackground,
          b.settingsInactiveIconBackground, t)!,
...
//You will be able to get the current theme from a widget called
//AppTheme which extends from InheritedWidget.
